    ...
    <div>
        ...
        <div class="wrap">
            <div class="search">
                ...
                <input type="submit"  @click="artcilesdata()" class="searchButton">
        ...
        <div class="main-container">
            ...
            <div class="cards" v-for="content in articles" :key="content.id">
                <div class="card">
                    ...
                    <h2 class="card__title">{{content.author}}ome hi</h2>
                    <p class="card__apply">
...
export default {
    ...
    methods: {
       async artcilesdata() {
            ...
            let filterdBlogs =  await axios.get(`https://newsapi.org/v2/everything?q=${this.searchbar}&from=2022-09-12&to=2022-09-12&sortBy=popularity&apiKey=ca7b8b07f01647a2a20dc31780387d53`)

            this.articles = filterdBlogs.data.articles
            let abc = this.articles
            console.log(abc)
